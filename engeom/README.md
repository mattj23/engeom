...
* **File I/O** (`io`): STL and PLY import/export (feature-gated), PCD point cloud import with all three payload
  encodings, the `lptf3` laser profile sensor format, and tolerance-based curve, cloud and mesh compression via the
  [`tol-compress`](https://crates.io/crates/tol-compress) crate.
